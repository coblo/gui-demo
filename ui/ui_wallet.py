...
class Ui_Wallet(QVBoxLayout):
    ...
    def init_addresses_ui(self):
        ...
        table_addresses.setFixedSize(
            table_addresses.horizontalHeader().length() + table_addresses.verticalHeader().width() + 2,
        ...
        vbox_addresses.addWidget(button_create_address, alignment=Qt.AlignRight)
    ...
    def init_history_ui(self):
        ...
        table_transactions.setFixedSize(
            table_transactions.horizontalHeader().length() + table_transactions.verticalHeader().width() + 19,
            400)
